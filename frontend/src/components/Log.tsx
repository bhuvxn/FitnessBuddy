  ...
  return (
   ...
   <div className="flex-shrink-0 bg-gray-800">
    <nav className="flex justify-between px-4 py-3">
      <a href="#" className="text-gray-300 hover:text-white">Add  Food</a>
      <a href="#" className="text-gray-300 hover:text-white">Add Biometric</a>
      <a href="#" className="text-gray-300 hover:text-white">Calorie Settings</a>
    </nav>
  </div>
